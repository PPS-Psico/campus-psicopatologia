...
export function publicGradingError(error) {
  ...
  const groups = [
    [400, [
      ...
      "annotation_text_mismatch", "invalid_moodle_context",
    ]],
    [401, ["invalid_grader_session"]],
    [403, ["grader_not_authorized", "grader_inactive", "coordinator_required", "not_a_grader"]],
    [404, ["exam_not_available", "attempt_not_available"]],
    [409, [
      "moodle_account_conflict", "attempt_not_claimable", "attempt_already_claimed", "attempt_not_owned",
